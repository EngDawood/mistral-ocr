...
إليك مثالًا على نتائج معالجة OCR من مستند PDF باللغة العربية. تتمكن الأداة من استخراج النص العربي وتحويله إلى تنسيق Markdown مع الحفاظ على هيكل المحتوى وتنسيقه الأصلي. هذا يُظهر قدرة الأداة على التعامل مع المستندات باللغة العربية بشكل فعال.


### مثال على ملف الإخراج (output.md)
انظر [output.md](output.md) للحصول على مثال كامل لإخراج OCR يُظهر نتائج معالجة النصوص العربية. يحتوي هذا الملف على الإخراج الفعلي من معالجة ورقة بحثية عربية حول تأثيرات علاج اضطراب فرط الحركة وتشتت الانتباه لدى الأطفال. يُظهر المثال قدرة الأداة على التعامل مع نصوص عربية معقدة مع الحفاظ على التنسيق والهيكل. يتضمن الإخراج محتوى أكاديمي يحتوي على عناوين وفقرات وتنسيق عربي تم استخراجها بنجاح من مستند PDF الأصلي.
